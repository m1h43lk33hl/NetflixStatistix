...
public class AccountsPanel extends JPanel {
     ...
     */
    public AccountsPanel(JComboBox<String> selectProfileBox, JLabel selectedAccountNameSeries, JLabel selectedAccountNameFilm)
    {
    ...
    private void createComponents()
    {
        ...
        selectProfileButton.addActionListener(new AccountsPanelSelectActionListener(this.selectProfileBox, selectAccountBox, this.selectedAccountNameSeries, this.selectedAccountNameFilm, accountLabelArray));
